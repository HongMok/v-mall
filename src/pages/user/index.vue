<template>
  <div>
    ...
    <div v-if="!userInfo">
      ...
      <button v-if="authType==0" class="unlogin-btn" open-type='getUserInfo' @getuserinfo='onGetUserInfo'>微信登录</button>
      <button v-if="authType==1" class="unlogin-btn" open-type='openSetting' @opensetting='onOpenSetting'>授权登录</button>
    </div>
