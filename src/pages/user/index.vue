<template>
  <div>
    ...
    <div v-if="!userInfo">
      ...
      <button v-if="authType==0" class="unlogin-btn" open-type='getUserInfo' @getuserinfo='onTapLogin'>微信登录</button>
      <button v-if="authType==1" class="unlogin-btn" open-type='openSetting' @opensetting="onTapLogin">授权登录</button>
    </div>
